...
// PATCH and DELETE /api/transactions/[id]) — hard block (429) once
// exceeded, keyed on Clerk user_id. Open public signup means these
// routes are now exposed to strangers, not just the developer.
//
