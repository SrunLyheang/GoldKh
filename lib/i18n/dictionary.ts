...
const km: typeof en = {
  ...
  hero: {
    ...
    disclaimer:
      "ហាងមាសនៅស្រុកខ្មែរកំណត់តម្លៃខុសពីតម្លៃទីផ្សារពិភពលោកដែលបង្ហាញនៅទីនេះ ដូច្នេះតម្លៃទិញ ឬលក់នៅផ្សារក្នុងស្រុក អាចខុសគ្នា។",
  },
  ...
  refresh: {
    ...
    couldntReach: "សូមព្យាយាមម្ដងទៀតបន្តិចទៀត",
    couldntRefresh: "សូមព្យាយាមម្ដងទៀតបន្តិចទៀត",
  },
  stat: {
    totalHoldings: "មាសសរុបដែលមាន",
  ...
  welcome: {
    ...
    features: {
      ...
      unitsBody:
        "បញ្ចូលបរិមាណតាមរបៀបដែលហាងមាសនៅស្រុកខ្មែរគេនិយាយ។ តម្លៃសំខាន់គិតជាដំឡឹង រួមមានជី និងអោនស៍ (troy ounce)។",
